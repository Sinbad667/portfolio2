      ...
      <section className="contact" id="contact">
        ...
        <div className="contact-content">
          ...
          <div className="social-links-contact">
            <a href="https://linkedin.com/in/bilal-hamzaoui" target="_blank" rel="noopener noreferrer" className="social-card">
              ...
              <div className="social-info">
                <h3>LinkedIn</h3>
                <p>{language === "EN" ? "Professional network" : "Réseau professionnel"}</p>
              </div>
            </a>
            <a href="https://github.com/Sinbad667" target="_blank" rel="noopener noreferrer" className="social-card">
              <div className="social-icon">
                <svg viewBox="0 0 24 24" fill="currentColor">
              ...
              <div className="social-info">
                <h3>GitHub</h3>
                <p>{language === "EN" ? "Code repositories" : "Dépôts de code"}</p>
              </div>
            </a>
          </div>
        </div>
      ...
      <div className="floating-cta">
        <div className="floating-cta-content">
          ...
          <div className="floating-cta-buttons">
            <a href="#projects" className="floating-btn primary">
              {language === "EN" ? "View Work" : "Voir Projets"}
            </a>
            <a href="#contact" className="floating-btn secondary">
